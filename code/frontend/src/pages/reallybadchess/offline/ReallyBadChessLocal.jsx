      ...
      >
        ...
        >
          <Box>
            <Typography
              variant="h4"
              sx={{ color: "red", fontWeight: "bolder" }}
            >
              Errore
            </Typography>
      ...
      <Box sx={ChessGameStyles.backgroundWrapper}>
        ...
        <div style={ChessGameStyles.divChessBoard}>
          <Chessboard
            ...
            onMouseOverSquare={
              (gameData.mode === "playerVsComputer" && chess.turn() === "w") ||
          ...
          <Box sx={ChessGameStyles.boxTurns}>
            ...
            <div>
              <Typography variant="h6" data-cy="player-turn">
                <b>
                  {chess.turn() === "w" ? gameData.player1 : gameData.player2}'s
                </b>{" "}
                turn
              </Typography>
            </div>
        ...
        <Box sx={ChessGameStyles.boxControlButtons}>
          ...
          <Button
            ...
            color="primary"
            onClick={() =>
              handleGameOver(chess.turn() === "w" ? "Nero" : "Bianco")
            }
            disabled={!endGameButtonEnabled}
          >
            Arrenditi
          </Button>
          <Button
