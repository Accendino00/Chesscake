                        ...
                        {leaderboardData.leaderboard.map((record, index, array) => {
                            return (
                                <React.Fragment key={"rank" + (index + 1)}>
                                    <LeaderBoardRecord rank={index + 1} username={record.username} value={record.rank} />
            ...
            {token && (
                <>
                    ...
                    {loading ? (
                        ...
                        <LeaderBoardRecord rank={leaderboardData.userPlace.place} username={leaderboardData.userPlace.username} value={leaderboardData.userPlace.rank} />
                    )}
                </>
            )}
        </Box>
