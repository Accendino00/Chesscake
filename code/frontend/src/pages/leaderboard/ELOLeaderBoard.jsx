    ...
    <Box>
      ...
      {loading ? (
        ...
        >
          ...
          <>
          {console.log("palle sudate", leaderboardData.leaderboard)}
          {leaderboardData.leaderboard.map((record, index, array) => {
            return (
              <React.Fragment key={"elo" + (index + 1)}>
                <LeaderBoardRecord
                  rank={index + 1}
        ...
        <>
          ...
          >
            ...
            <ShareButton
              ...
              text={
                ...
                " di ELO su Really Bad Chess! Provalo anche tu sul sito di Chess Cake!"
              }
              style={{
                marginLeft: "10px",
                width: "30px",
          ...
          {loading ? (
            ...
            <LeaderBoardRecord
              ...
              value={leaderboardData.userPlace.elo}
            />
          )}
        </>
      )}
