            ...
            <Box style={{
                ...
                <Box style={{
                    ...
                    <Typography style={{
                        ...
                        <br /> <br />
                        Il sito è stato sviluppato per il corso di <i>Ingegneria del Software</i> dell'Università degli Studi di Bologna dal team T3 nell'AA 2023/2024.
                    </Typography>

                    <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end' }}>
                        <Button
